...
map.getView().fit([8460162.722294, 1299454.938774, 8500529.976049, 1326620.086556], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">poothadi webgis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (61 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this website created usimg opensoftware part of Msc programme';
            }
